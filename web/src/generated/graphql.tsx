...
export type MoviesQuery = (
  ...
  & { movies: Array<(
    { __typename?: 'Movie' }
    & Pick<Movie, 'id' | 'title' | 'info'>
  )> }
);

export const MainUserFragmentDoc = gql`
    fragment MainUser on User {
  id
  username
  email
}
...
export const RegisterDocument = gql`
    mutation Register($username: String!, $options: EmailPasswordInput!) {
  register(username: $username, options: $options) {
    ...MainUser
  }
}
    ${MainUserFragmentDoc}`;
...
export const MoviesDocument = gql`
    query Movies($limit: Float!, $offset: Float!) {
